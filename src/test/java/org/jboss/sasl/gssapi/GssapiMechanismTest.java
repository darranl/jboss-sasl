...
import static org.jboss.sasl.gssapi.JAASUtil.loginClient;
import static org.jboss.sasl.gssapi.JAASUtil.loginServer;
...
public class GssapiMechanismTest extends BaseTestCase {
    ...
    private void testSasl(final String actualServer, final String expectedServer, final boolean authServer,
        ...
        try {
            ...
            assertEquals("Authorization ID", "jduke@JBOSS.ORG", server.getAuthorizationID());
